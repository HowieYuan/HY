...
title:      一行代码完成 JAVA 的 EXCEL 读写——EasyExcel 的方法封装               # 标题 
subtitle:    #副标题
date:       2018-09-11              # 时间
author:     Howie                      # 作者
header-img: img/easyexcel-method.jpg    #这篇文章标题背景图片
catalog: true                       # 是否归档
tags:                               #标签
    - Java
    - excel
...
>
> 附上源码：https://github.com/HowieYuan/easyexcel-method-encapsulation

# EasyExcel 
EasyExcel 的 github 地址： https://github.com/alibaba/easyexcel
EasyExcel 的官方介绍：

![](https://upload-images.jianshu.io/upload_images/8807674-8d9060c8ead8b0d3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
